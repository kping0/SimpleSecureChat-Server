...
#define custom_malloc(size) sscs_cmalloc(size,__FILE__,__LINE__) 
#define custom_free(ptr) sscs_cfree(ptr,__FILE__,__LINE__) 
#define chkaddr(ptr) sscs_chkaddr(ptr,__FILE__,__LINE__)
#define objsize(ptr) sscs_heap_object_size(ptr,__FILE__,__LINE__)
